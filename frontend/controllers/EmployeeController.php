...
class EmployeeController extends \yii\web\Controller {
    ...
    public function PDV($model) {
        ...
        if (!empty($referrer)) {
            ...
            if ($this->WalletHistory(2, $employee_wallet, $previou_wallet, $commission, 0, $tax_amount, 0, $service_amount, $pdv_amount, '', '', $model->id))
                $flag = 1;
        }
        if ($flag == 1) {
            return true;
    ...
    public function WalletHistory($type, $user, $previou_wallet, $bv_match, $tax, $tax_amount, $service, $service_amount, $commision, $company = null, $company_amount = null, $added_employee = null) {
        ...
        $wallet_history->employe_added = $added_employee;
