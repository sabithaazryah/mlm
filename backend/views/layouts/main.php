                    ...
                    <header class="logo-env">
                        ...
                        <div class="logo">
                            ...
                            <a href="" class="logo-collapsed">
                                <img width="40" height="40" src="<?= Yii::$app->homeUrl ?>images/logo-footer.png"/>
                            </a>
                        </div>
                    ...
                    <ul id="main-menu" class="main-menu">
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <?= Html::a('Add Product', ['/products/products/index'], ['class' => 'title']) ?>
                                </li>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <?= Html::a('Bank Details', ['/masters/bank-details/index'], ['class' => 'title']) ?>
                                </li>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <?= Html::a('Settings', ['/masters/settings/index'], ['class' => 'title']) ?>
                                </li>
